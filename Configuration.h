...
#define STRING_CONFIG_H_AUTHOR "(Olly)" // Who made the changes.
...
#define MACHINE_UUID "c041d38a-e3d3-4cb8-88d1-d5b3a6f944ba"
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // Malyan M150 example
  #define  DEFAULT_Kp 40.89
  #define  DEFAULT_Ki 3.96
  #define  DEFAULT_Kd 105.48
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (((X_MIN_POS + X_MAX_POS) / 2) + 10)    // X point for Z homing when homing all axis (G28).
